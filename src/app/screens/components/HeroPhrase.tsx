...
const HeroPhrase = () => {
  return (
    <Stack alignItems="center" className="HeroPhrase" paddingY={12} spacing={3}>
      <Text as="h1" color="secondary.500" fontSize={["3xl","5xl"]} fontWeight="700" letterSpacing="-1.5px" textAlign="center">
        A history of everything you copy
      </Text>
      <Text color="secondary.200" fontSize={["md","xl"]} maxWidth="container.md" textAlign="center">
